...
- [x] Model optimization, benchmarking, FastAPI serving, containerization
- [x] Cloud deployment (AWS EC2), MLflow experiment tracking, restart policy for crash/reboot recovery
- [x] Airflow orchestration DAG, GitHub Actions CI/CD, DVC + S3 dataset/model versioning
- [x] Prometheus/Grafana observability, Locust load testing, lightweight drift detection
